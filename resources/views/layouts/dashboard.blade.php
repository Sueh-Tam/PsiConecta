...
<body>
    ...
    <nav class="sidebar">
        ...
        <a href="{{ Route('patient.dashboard') }}" class="@if(request()->is('dashboard/consultas')) active @endif">
            <i class="bi bi-calendar-check"></i>
            Consultas
        </a>
        <a href="{{ Route('patient.packages') }}" class="@if(request()->is('dashboard/pacotes')) active @endif">
            <i class="bi bi-box"></i>
            Pacotes
        </a>
        <a href="{{ Route('patient.profile') }}" class="@if(request()->is('dashboard/perfil')) active @endif">
